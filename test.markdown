...
<p>Персонализированную рекламу в&nbsp;интернете маркетологи преподносят как благо. Объявления показываются с&nbsp;учетом действий пользователя и&nbsp;поэтому человек видит только полезную рекламу. Предполагается, все должны быть довольны. Но&nbsp;это не&nbsp;так. </p>
<p>Количество установок блокировщиков рекламы растет (<a href="https://bartoshevich.by/mnenie/sem-tendencij-marketinga/#1">данные Adobe и&nbsp;PageFair</a>, <a href="https://adindex.ru/news/researches/2019/09/19/275603.phtml" target="_blank" rel="noopener">данные Deloitte</a>). Система сбора личной информации, которая лежит в&nbsp;основе персонализированной рекламы, не&nbsp;нравится (<a href="https://www.ama.org/marketing-news/reassuring-consumers-on-the-use-of-their-data/" target="_blank" rel="noopener">исследование Ryerson University</a>). Люди стали меньше делиться информацией в&nbsp;сети (<a href="https://marketingland.com/most-consumers-believe-online-privacy-is-impossible-survey-finds-263538" target="_blank" rel="noopener">исследование FigLeaf</a>) и&nbsp;в&nbsp;принципе могут отказаться от&nbsp;участия в&nbsp;маркетинговых активностях, где нужно предоставить сведения о&nbsp;себе. То, что создавалось для роста эффективности интернет-маркетинга, может ее&nbsp;и&nbsp;похоронить. Давайте разбираться, как подружить онлайн рекламу с&nbsp;потребителями. </p>

<nav class="toc">
<ul>
		  <li>
		    <a href="#1">
		      <span class="tocnumber">1 </span>Время блокировать рекламу 
		    </a>
		  </li>
		  <li class="level2">
		    <a href="#1.1">
		      <span class="tocnumber">1.1 </span>Рекламные сети плодят сайты низкого качества
		    </a>
		  </li>
			<li class="level2">
		    <a href="#1.2">
		  ...
		  <li class="level2">
			...
			<li>
			 <a href="#2">
				 <span class="tocnumber">2 </span>Отношения с&nbsp;гугл, яндекс, фейсбуком и&nbsp;пр. —&nbsp;неравноправные
			 </a>
		 </li>
		 <li>
			<a href="#3">
...
<h2 id="1">Время блокировать рекламу </h2>
<p>Чтобы понять мотивы блокировщиков рекламы, предлагаю подробно рассмотреть основные претензии к&nbsp;рекламе. Выделил три группы. </p>

<h3 id="1.1" >Рекламные сети плодят сайты низкого качества. </h3>
...
<h2 id="2">Отношения с&nbsp;гугл, яндекс, фейсбуком и&nbsp;пр. —&nbsp;неравноправные </h2>
...
<p>Общее, что объединяет перечисленные выше недостатки персонализированной рекламы,&nbsp;— недоверие пользователей. Большинство людей не&nbsp;стремятся к&nbsp;100% анонимности, не&nbsp;бегут и&nbsp;не&nbsp;скрываются. Однако, их&nbsp;не&nbsp;устраивает ситуация, когда сведения о&nbsp;частной жизни используют «в&nbsp;темную». Задача сейчас&nbsp;— вернуть доверие. </p>
<p>Несколько идей, как начать постепенно исправлять ситуацию: </p>
<ul> 
	...
	<li>Рекламная активность в&nbsp;интернете должна подчиняться мета-цели&nbsp;— вызвать доверие. Важно не&nbsp;продать с&nbsp;первой попытки, не&nbsp;бросаться на&nbsp;потенциального клиента шквалом объявлений, а&nbsp;— как в&nbsp;свое время выразился Сет Годин&nbsp;— получить разрешение на&nbsp;продолжение коммуникации. </li>
 </ul>