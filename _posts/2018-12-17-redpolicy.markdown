...
description: "Раньше думал, что редакционная политика — то, что относится к сфере СМИ. Я ошибался. Если вы разработали концепцию бренда — беритесь за редакционную политику."
date:   2018-12-17 06:18:33 +0300
categories: опыт
