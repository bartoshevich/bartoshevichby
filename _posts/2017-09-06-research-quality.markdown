...
<ul>
  <li>
    <a href="#1">
      <span class="tocnumber">1 </span>Принципы контроля работы с&nbsp;исследовательскими агентствами
    </a>
  </li>
  <li>
    <a href="#2">
 ...
 <h2 id="1">Принципы контроля работы с&nbsp;исследовательскими агентствами</h2>
