...
<p>Если не&nbsp;ведется аудиозапись и&nbsp;интервьюер решит обмануть работодателя, он&nbsp;задаст респондентам <nobr>3-5</nobr> вопросов из&nbsp;анкеты, а&nbsp;на&nbsp;остальные ответит сам. И&nbsp;вероятность обнаружения обмана мала. Когда&nbsp;же интервью записывается, вы&nbsp;сможете проверить качество опроса от&nbsp;начала до&nbsp;конца и&nbsp;сразу выявить «Василис-работниц», которые заполняют анкеты «на&nbsp;коленке».</p>
