---
layout: post
title:  "Вы заказали исследование. Как контролировать качество работы агентства"
...
<p>  Надежность результатов исследования не&nbsp;гарантирует ни&nbsp;опыт, ни&nbsp;статус международной компании. В&nbsp;регионах России, например, крупные агентства могут работать через местных подрядчиков. И&nbsp;где задействованы большие бюджеты, найдутся&nbsp;те, кто «нарисует» любую анкету, распределив ответы наугад.</p>

 <p> <mark>Наймите специалиста, который не&nbsp;менее 2,5 лет проработал в&nbsp;исследовательском агентстве, и&nbsp;контролировать ход исследования будет проще.</mark> Этот человек будет мотивировать агентство постоянно следить за&nbsp;качеством работы. Он&nbsp;проверит формулировки и&nbsp;порядок вопросов, шкалы, квотирование, выборку, способ анализа. Не&nbsp;постесняется посмотреть заполненную анкету и&nbsp;позвонить респондентам узнать, участвовали&nbsp;ли они в&nbsp;исследовании.</p> 
 ...
 <p>&nbsp;</p>
 <h2>Особенности контроля качества проведения</h2>
<h3>а) ... личных интервью </h3>
...
<aside class="aside-text-right"><mark>Предложения по&nbsp;проведению опросов без аудиозаписи отклоняйте!</mark></aside>
<p>Если интервьюер решит обмануть работодателя, то&nbsp;он&nbsp;задаст респондентам <nobr>3-5</nobr> вопросов из&nbsp;анкеты, а&nbsp;на&nbsp;остальные ответит сам. И&nbsp;вероятность обнаружения обмана мала. </p>



<!--<p>В&nbsp;исследовательском агентстве, где я&nbsp;работала, была такая история: мы&nbsp;раздали интервьюерам планшеты и&nbsp;не&nbsp;предупредили, что запись интервью будет включаться автоматически. Когда получили записи и&nbsp;прослушали&nbsp;— был шок. Очень много интервью не&nbsp;соответствовали стандартам качества и&nbsp;анкеты пришлось отправить в&nbsp;брак. Запомнилась воспитательница садика, которая, никого не&nbsp;опрашивая, заполняла анкеты сама и&nbsp;рассказывала коллеге: «Вот так и&nbsp;работаю. А&nbsp;что, посидела два часа, заполнила 20&nbsp;анкет, себе на&nbsp;колготки заработала. Вот такая я&nbsp;Василиса-работница».</p>-->
