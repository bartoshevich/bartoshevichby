...
<div class="side">
При опросе в&nbsp;интернете старайтесь соотнести респондентов с&nbsp;оффлайн идентификаторами. 
</div></div>	
<h3>в) ... фокус-групп</h3>
<div class="with-side">
<p><strong>Екатерина Палховская:</strong> Агентство может не&nbsp;справляться с&nbsp;поиском участников фокус-групп и&nbsp;попытаться закрыть дыры знакомыми: привести человека и&nbsp;подогнать его под критерии отбора. «Купи один раз, попробуй, потом скажешь, что покупаешь регулярно». </p>
<div class="side">Заказчику исследования важно присутствовать на&nbsp;этапе предварительного интервью, которое проводится перед фокус-группой.</div></div>
