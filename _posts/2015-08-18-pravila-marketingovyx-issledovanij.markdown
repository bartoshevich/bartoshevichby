...
<table> 
	<tbody> 
		...
		<tr> 
			...
			<td><em>В&nbsp;прошлом месяце от&nbsp;нас отказалось 13&nbsp;клиентов. <em></td>
 		</tr>
		<tr> 
			<td>1)&nbsp;&nbsp; </td>
			<td>данные упорядочены, группировка по&nbsp;некий критериям, сопоставление показателей и&nbsp;параметров </td>
			<td><em>Выявлена общая причина и&nbsp;характерное поведение накануне. У&nbsp;нас есть 9&nbsp;клиентов с&nbsp;похожими «симптомами».</em></td>
 		</tr>
		<tr> 
			<td>2)&nbsp;&nbsp;</td>
