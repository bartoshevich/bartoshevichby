---
layout: post
title: "Тенденции, которые нельзя игнорировать маркетологам"
...
image: /images/tizer-14.jpg
---

<p>Тенденции, описанные ниже, отражают изменения в&nbsp;покупательском поведении и&nbsp;развитии маркетинга. Если вы&nbsp;не&nbsp;намереваетесь выпасть из&nbsp;поля зрения потенциальных клиентов, обратите на&nbsp;них внимание.</p>

<nav class="toc">
<ul>
  <li>
    <a href="#1">
      <span class="tocnumber">1 </span>Навязчивая реклама умирает
    </a>
  </li>
  <li>
    <a href="#2">
      <span class="tocnumber">2 </span>Ориентация на&nbsp;диалог с&nbsp;клиентом
    </a>
  </li>

  <li>
        <a href="#3">
        <span class="tocnumber">3 </span>Рост мобильного интернет-трафика
        </a>
      </li>
      <li>
        <a href="#4">
        <span class="tocnumber">4 </span>Рост скорости реагирования
        </a>
      </li>
      <li>
        <a href="#5">
        <span class="tocnumber">5 </span>Использование эмоций в&nbsp;маркетинговых коммуникациях
        </a>
      </li>
      <li>
        <a href="#6">
        <span class="tocnumber">6 </span>Рост качества контента
        </a>
      </li>
      <li>
        <a href="#7">
        <span class="tocnumber">7 </span>Рост видеоконтента
        </a>
      </li>
    </ul>
</nav>
...
<h2 id="2">2) Ориентация на&nbsp;диалог с&nbsp;клиентом</h2>
<p>В&nbsp;2015&nbsp;г. маркетологи Nescafe <a href="https://vc.ru/marketing/10580-nescafe-tumblr" target="_blank" rel="noopener">закрыли корпоративный сайт</a>. Объяснили тем, что он&nbsp;не&nbsp;подталкивает клиентов к&nbsp;общению. Поэтому всю коммуникацию перенесли в&nbsp;блог на&nbsp;платформе Tumblr.</p>
...
<h2 id="3">3) Рост мобильного интернет-трафика</h2>
...
<p>Google помогает определить, <a href="https://search.google.com/test/mobile-friendly" target="_blank" rel="noopener">насколько удобно просматривать сайт на&nbsp;мобильных устройствах,</a> и&nbsp;подсказывает, что исправить. Если вы&nbsp;еще не&nbsp;тестировали свой сайт в&nbsp;прошлом году, сделайте это после прочтения статьи.</p>
<h2 id="4">4) Рост скорости реагирования</h2>
...
<h2 id="5">5) Использование эмоций в&nbsp;маркетинговых коммуникациях</h2>
...
<h2 id="6">6) Рост качества контента</h2>
...
<h2 id="7">7) Рост видеоконтента</h2>
<p>О&nbsp;необходимости использования видеороликов говорят и&nbsp;web-разработчики, и&nbsp;seo-шники и&nbsp;специалисты по&nbsp;соц.сетям. Каждый со&nbsp;своей стороны подчеркивает плюсы. По&nbsp;оценкам Cisco, <a href="https://www.cisco.com/c/en/us/solutions/collateral/service-provider/visual-networking-index-vni/white-paper-c11-741490.html" target="_blank" rel="noopener">доля видео в&nbsp;2019г. составит&nbsp;80% от&nbsp;мирового интернет-трафика.</a></p>
