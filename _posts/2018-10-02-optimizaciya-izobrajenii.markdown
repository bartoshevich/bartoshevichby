---
layout: post
title:  "Оптимизация изображений: способы, о которых вы могли не знать"
name: "Как оптимизировать изображения: способы, о которых вы могли не знать"
description: "Делюсь способами оптимизации изображений для сайта, которые использую сам и рекомендую другим"
date:   2018-10-02 06:18:33 +0300
...
<h2>Новое требование: каждому экрану свое изображение </h2>
...
<div class="with-side">
<p>Если вы&nbsp;читаете статью на&nbsp;смартфоне, ниже вы&nbsp;видите котенка, который спит, свернувшись калачиком. Если читаете с&nbsp;большого экрана&nbsp;— ваш кот зевает и&nbsp;потягивается. Еще есть кот, который сидит и&nbsp;смотрит на&nbsp;вас. Поэкспериментируете с&nbsp;гаджетами или размером окна браузера и&nbsp;убедитесь, что так и&nbsp;есть. </p>
...
<p>Ниже — оптимизированная с&nbsp;помощью Cloudinary фотография монеты. Если вы&nbsp;откроете статью на&nbsp;разных браузерах (Firefox и&nbsp;Chrome) и&nbsp;сохраните фото, вы&nbsp;получите фотографии разных форматов и&nbsp;веса. У&nbsp;меня скачанная с&nbsp;Chrome фотография весит всего 10,9&nbsp;КБ&nbsp;— почти в&nbsp;10&nbsp;раз меньше оригинала. Код&nbsp;же&nbsp;— одна строка. Нет &lt;picture&gt;, &lt;source&gt;, media и&nbsp;пр. </p>
