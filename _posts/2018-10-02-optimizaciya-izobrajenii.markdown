...
<ul> 
	...
	<li> 
		<p>Появился <a href="https://developers.google.com/speed/webp/">новый формат изображений&nbsp;— WebP</a>, который делает вес фото еще меньше. Пока формат поддерживается не&nbsp;всеми браузерами → для браузеров, которые «видят» WebP, следует предлагать WebP, а&nbsp;остальным&nbsp;— другие форматы. </p>
	</li>
	<li> 
...
<div class="side">Пример взят <a href="https://cloudfour.com/examples/img-currentsrc/">отсюда</a></div></div>
