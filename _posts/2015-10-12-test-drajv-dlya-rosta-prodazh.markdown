---
layout: post
title: "Шесть причин предложить протестировать продукта"
name: "Зачем предлагать покупателю протестировать продукт"
...
<figcaption>тест-драйв блендера: справится ли с iPhone 6&nbsp;Plus и&nbsp;Samsung Galaxy Note&nbsp;3?
</figcaption>
</figure>
