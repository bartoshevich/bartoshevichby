...
<div class="row">
    <div class="c-6">
       <p><img class="guest-image" src="/images/sto1.jpg" alt="Катерина Пажитных" width="150" height="150"/></p>
                  <div class="person"><strong>Екатерина Пажитных</strong><br/>
 маркетолог</div>

  </div>
  <div class="c-6">
       <p><img class="guest-image" src="/images/sto2.jpg" alt="Алексей Шлома" width="150" height="150" /></p>
...
<h2>Что маркетолог должен сделать в&nbsp;первые сто дней?</h2>
...
<h2>Что маркетологу делать не&nbsp;следует?</h2>
...
<h2>Как начать выстраивать отношения с&nbsp;отделом продаж?</h2>
<div class="with-side">
<div class="side">
